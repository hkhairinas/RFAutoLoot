    ...
    public partial class AutoLoot : Form
    {
        ...
        private void btnHelp_Click(object sender, EventArgs e)
        {
            string message =
                ...
                "Cara Pakai :\n" +
                "1. Pilih Targetnya\n" +
                "2. Set Waktunya Bebas(Biarkan Default Agar Lebih Cepat!)\n" +
                "3. Klik Start\n" +
                "4. Pencet Tombol F1 untuk On / Off!\n" +
                "5. Autoloot berjalan\n" +
                "Happy Farming!\n\n" +
    ...
    private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            if (RFWindowHandle != IntPtr.Zero)
            {
                DllImports.SetForegroundWindow(RFWindowHandle);
                DllImports.ShowWindow(RFWindowHandle, SW_SHOW);
            }
